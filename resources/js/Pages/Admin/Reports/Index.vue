...
function setPreset(p) {
    preset.value = p;
    // Let the backend recompute from/to for the preset by omitting them.
    router.get('/admin/reports', {
        preset: p,
        resource_id: resourceId.value || undefined,
    ...
    <AdminLayout>
        ...
        <div class="card p-4 mb-6 flex flex-wrap items-end gap-3">
            <div class="flex gap-1.5">
                <button
                    v-for="p in ['monthly', 'quarterly', 'yearly']"
                    :key="p"
                    @click="setPreset(p)"
        ...
        <div class="grid lg:grid-cols-2 gap-6">
            <div class="card overflow-hidden">
                ...
                <table class="w-full text-sm">
                    <thead class="bg-chalk-100 text-left text-xs uppercase tracking-wide text-ink-700/60">
                        <tr><th class="px-5 py-2.5">Period</th><th class="px-5 py-2.5">Bookings</th><th class="px-5 py-2.5">Income</th></tr>
                    </thead>
            ...
            <div class="card overflow-hidden">
                ...
                <table class="w-full text-sm">
                    <thead class="bg-chalk-100 text-left text-xs uppercase tracking-wide text-ink-700/60">
                        <tr><th class="px-5 py-2.5">Ground</th><th class="px-5 py-2.5">Bookings</th><th class="px-5 py-2.5">Income</th></tr>
                    </thead>
                    <tbody class="divide-y divide-chalk-200">
